...
<div style="margin-left:150px;">
	...
	<div class="pd-20">
		...
		<div class="mt-20">
			<iframe src="<%=ctxPath%>/Merchant?action=showPassedMerchantByTypeId&id=2" id="testIframe"  width="100%" height="700"  frameborder="no" border="0" marginwidth="0" marginheight="0"  allowtransparency="yes">
	...
	callback: {
		beforeClick: function(treeId, treeNode) {
			...
			if (treeNode.isParent) {
				...
				demoIframe.attr("src","<%=ctxPath%>/Merchant?action=showPassedMerchantByTypeId&id="+treeNode.id);
				return true;
			}
		}
	}
...
var json_MerchantType= ${merchantTypes};


zNodes.push({ id:1, pId:0, name:"一级分类", open:true});
for(var i=0;i<json_MerchantType.length;i++){
	zNodes.push({id:(json_MerchantType[i].id)+1, pId:1, name:json_MerchantType[i].name});
}
