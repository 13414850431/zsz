...
<div class="pd-20">
  <form action="" method="post" class="form form-horizontal" id="form-role-add">
  	<input type="hidden" name="action" value="editTypeSubmit"/>
  	<input type="hidden" name="id" value="${merchantType.id}"/>
    <div class="row cl">
      <label class="form-label col-3"><span class="c-red">*</span>分类名：</label>
      <div class="formControls col-5">
        <input type="text" class="input-text" value="${merchantType.name}" placeholder="" id="member-name" name="typeName" datatype="*2-16" nullmsg="分类名不能为空" >
      </div>
      <div class="col-4"> </div>
    </div>
     ...
     <div class="row cl">
      ...
      <div class="formControls col-5">
        <textarea name="typeDescription" style="height:200px;width:300px;" class="textarea radius" placeholder="商品分类描述" rows="10" cols="50">${merchantType.description}</textarea>
      </div>
      <div class="col-4"> </div>
    </div>
