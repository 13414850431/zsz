...
<div style="margin-left:150px;">
	...
	<div class="pd-20">
		...
		<div class="mt-20">
			<iframe src="<%=ctxPath%>/Merchant?action=showkilledMerchantByTypeId&id=2" id="testIframe"  width="100%" height="700"  frameborder="no" border="0" marginwidth="0" marginheight="0"  allowtransparency="yes">
	...
	callback: {
		beforeClick: function(treeId, treeNode) {
			...
			if (treeNode.isParent) {
				...
				demoIframe.attr("src","<%=ctxPath%>/Merchant?action=showkilledMerchantByTypeId&id="+treeNode.id);
				return true;
			}
		}
	}
