...
<aside class="Hui-aside">
	...
	<div class="menu_dropdown bk_2">
		...
		<dl id="menu-product">
			...
			<dd>
				<ul>
					<li><a _href="<%=ctxPath %>/Merchant?action=showMerType" href="javascript:void(0)">分类管理</a></li>
					<li><a _href="product-category.html" href="javascript:void(0)">待审批商家申请</a></li>
					<li><a _href="product-list.html" href="javascript:void(0)">已启用商家管理</a></li>
					<li><a _href="product-list.html" href="javascript:void(0)">已下架商家</a></li>
				</ul>
			</dd>
		</dl>
		<!--<dl id="menu-page">
		...
		<dl id="menu-comments">
			...
			<dd>
				<ul>
					<li><a _href="member-record-share.html" href="javascript:;">评论列表</a></li>
