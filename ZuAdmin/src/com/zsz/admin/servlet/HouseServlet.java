...
public class HouseServlet extends BaseServlet {
	...
	public void add(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		AdminUserDTO adminUser =adminUserService.getById(AdminUtils.getAdminUserId(req));
		String cityName = adminUser.getCityName();
	...
	public void addSubmit(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		String[] selectLocations = selectLocation.split(",");
		String latitude = selectLocations[0];	//纬度
		String longitude = selectLocations[1];	//经度
	...
	public void editSubmit(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		String selectLocation = req.getParameter("selectLocation");
		String[] locs = selectLocation.split(",");
		
		String latitude = locs[1];//纬度
		String longitude = locs[0];//经度
