...
public class FrontUtils {
	...
	public static long getCurrentCityId(HttpServletRequest req,String cityName) {
		...
		//如果没人登录、而且session也没有CityId，则用当前定位的城市cityName
	...
	//获得当前城市Id（依次从“当前登录用户”、“session”、“第一个城市”中获取）
		public static long getCurrentCityId(HttpServletRequest req) {
			...
			//如果没人登录、而且session也没有CityId，则用第一个城市的id
			CityService cityService = new CityService();
